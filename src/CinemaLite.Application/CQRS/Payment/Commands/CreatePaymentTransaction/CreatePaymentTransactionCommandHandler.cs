...
public class CreatePaymentTransactionCommandHandler(
    ...
    : IRequestHandler<CreatePaymentTransactionCommand, CreatePaymentResponse>
{
    public async Task<CreatePaymentResponse> Handle(CreatePaymentTransactionCommand request,
        CancellationToken cancellationToken)
    {
        ...
        try
        {
            var order = await dbContext.Orders
                .FirstOrDefaultAsync(o => o.Id == request.OrderId && o.Status == OrderStatus.Pending, 
                    cancellationToken);
